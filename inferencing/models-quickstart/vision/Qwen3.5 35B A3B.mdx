...
description: "> The breakout model of the Qwen3.5 Medium Series — 35B total parameters with only 3B active, delivering historic efficiency with frontier-level vision and reasoning on an 8GB GPU."
---
