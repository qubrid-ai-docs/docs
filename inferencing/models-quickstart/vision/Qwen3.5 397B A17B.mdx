...
description: "> Alibaba's flagship open-source native multimodal model — trained from scratch on text, image, and video with 397B total parameters and 17B active per token."
---
